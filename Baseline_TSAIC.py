"""
Baseline U2Net + TSAIC attention block.
...
# Baseline (U2Net) with TSAIC
class Baseline_TSAIC(nn.Module):

    def __init__(self, in_ch=1, mid_ch=32, out_ch=64):
        super(Baseline_TSAIC, self).__init__()
        ...
        # output layer
        # Predict enhanced magnitude spectrum directly (Mapping)
